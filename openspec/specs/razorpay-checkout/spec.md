...
This specification defines the requirements for integrating Razorpay payment gateway checkout functionality into the net worth certificate generator application.
